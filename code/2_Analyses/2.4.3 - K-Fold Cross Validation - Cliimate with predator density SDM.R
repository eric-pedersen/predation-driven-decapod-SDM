### K-Fold Cross validation for Climate + Predator density SDMs ----
...
Data_Crab<-Data_Crab[region=="Maritimes"|region=="Quebec"|region=="Gulf"|region=="Newfoundland_fall"|region=="Newfoundland_spring"]
...
climate_crabmodel<-gam(chionoecetes_opilio_small~s(temperature_at_bottom,k=6)+
                         ...
                         s(region,year_surv, bs="re",by=dummy), #year-by-region random effects
                       family=tw(),
                       data=Data_Crab,subset=(region=="Maritimes"|region=="Quebec"|region=="Gulf"|region=="Newfoundland_fall"|region=="Newfoundland_spring"),
                       method="REML")
